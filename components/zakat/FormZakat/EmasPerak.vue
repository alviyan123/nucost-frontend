  ...
  <form class="form-horizontal mt60" @submit.prevent="countDirect">
    <div class="row">
      <div class="form-group pb-2">
        ...
        <div class="input-group">
          ...
          <client-only>
            <money class="form-control" placeholder="Contoh: Rp.1.000.000" v-bind="money" v-model="emas.emas" ></money>
          </client-only>
        </div>
      </div>
      <div class="form-group pb-2">
        ...
        <div class="input-group">
          ...
          <client-only>
            <money class="form-control" placeholder="Contoh: Rp.1.000.000" v-bind="money" v-model="emas.perak" ></money>
          </client-only>
        </div>
      </div>
      <div class="form-group pb-2">
        <label for="formID">Logam Mulia</label>
        <div class="input-group">
          <div class="input-group-prepend">
            <div class="input-group-text">Rp.</div>
          </div>
          <client-only>
            <money class="form-control" placeholder="Contoh: Rp.1.000.000" v-bind="money" v-model="emas.logammulia" ></money>
          </client-only>
        </div>
      </div>
      <div class="form-group pb-2">
        ...
        <div class="input-group">
          ...
          <client-only>
            <money class="form-control" placeholder="Contoh: Rp.1.000.000" v-bind="money" v-model="emas.hutang" ></money>
          </client-only>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-12 col-md-12 form-group text-green zakat-total">
        <client-only>
        <strong>Zakat Emas, Perak dam Logam Mulia Kamu<br /></strong
